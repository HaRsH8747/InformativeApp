...
class VehiclesActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val titleArray = resources.getStringArray(R.array.vehicles_title)
        val descriptionArray = resources.getStringArray(R.array.vehicles_description)
        val images = mapOf<String,List<Int>>(
            titleArray[0] to listOf(R.drawable.pickup_truck),
            titleArray[1] to listOf(R.drawable.monster_truck),
            titleArray[2] to listOf(R.drawable.amphibious_truck),
            titleArray[3] to listOf(R.drawable.sports_car),
            titleArray[4] to listOf(R.drawable.jeep)
        )
